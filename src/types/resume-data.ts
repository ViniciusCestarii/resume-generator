...
export const resumeData: ResumeData = {
  ...
  experience: [
    ...
    },
    {
      ...
      responsibilities: [
        "Collaborated and mantained a multi-tenancy admin web application (.NET, React, Next.js) for more than 60 tenants.",
  ...
  projects: [
    {
      ...
      description: "Engineered full-stack CMS using Next.js 14 App Router with MDX content pipeline, enabling code snippet embedding and Admin acess for managing posts.",
